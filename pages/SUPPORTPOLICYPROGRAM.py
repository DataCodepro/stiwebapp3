...
def EDA():
    ...
    if select == 'TABLE':
        ...
        df2.replace({'policysup1':'Importance of govt support policy/prog - R&D funding',
            ...
            'policysup8':'Importance of govt support policy/prog - Others'},inplace=True) 
        st.table(df2)
        if st.checkbox('SUPPORT POLICY PROGRAM CHART'):
            df3 = df[['policysup1','policysup2','policysup3','policysup4','policysup5','policysup6','policysup7','policysup8']]
...
st.markdown("#IMPORTANCE OF GOVERNMENT SUPPORT POLICY PROGRAMM ANALYSIS")
st.header(
        """IMPORTANCE OF GOVERNMENT SUPPORT POLICY PROGRAMM""")
EDA()  
