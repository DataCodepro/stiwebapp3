...
def EDA():
    ...
    if select == 'TABLE':
        ...
        df101.rename({'sinfo1':'Information source - Internal','sinfo2':'Information source - Suppliers','sinfo3':'Information source - Customers','sinfo4':'Information source - Competitors','sinfo5':'Information source - Consultants, commercial labs or private R&D institutes','sinfo6':'Information source - Universities, other higher ed. Institutions','sinfo7':'Information source - Public research institutes','sinfo8':'Information source - Conferences, fairs, exhibitions','sinfo9':'Information source - Journals, trade publications','sinfo10':'Information source - Professional, industry associations'},axis = 1,inplace=True)
        st.table(df101)
